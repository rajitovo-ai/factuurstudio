                      ...
                      <td className="py-4">
                        <div className="flex justify-end gap-2">
                          ...
                          <button
                            ...
                            disabled={!canSend}
                            className="rounded-lg border border-cyan-200 px-3 py-2 text-xs font-semibold text-cyan-700 transition hover:bg-cyan-50 disabled:cursor-not-allowed disabled:opacity-50"
                          >
                            Markeer verzonden
                          </button>
                          <button
                            ...
                            className="rounded-lg border border-emerald-200 px-3 py-2 text-xs font-semibold text-emerald-700 transition hover:bg-emerald-50 disabled:cursor-not-allowed disabled:opacity-50"
                          >
                            Markeer betaald
                          </button>
                          <button
